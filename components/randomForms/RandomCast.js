...
//     const randomCast = {
//       name: 'i',
//       image: 'https://media.gettyimages.com/photos/stack-of-books-picture-id157482029?s=2048x2048',
//       actions: '4',
//       adventuringSkills: '4',
//       armour: '4',
//       castId: '4',
...
//       <h2 className="text-black mt-2">{obj.firebaseKey}Random Cast</h2>
//       <Row className="mb-2">
//         <Form.Group as={Col} controlId="formGridName">
//           <FloatingLabel controlId="floatingTextarea" label="Name" className="mb-1">
//             <Form.Control size="sm" type="text" placeholder="Name" name="name" value={randomCast.name} onChange={handleChange} required />
//           </FloatingLabel>
//         </Form.Group>
